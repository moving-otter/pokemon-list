...
import {PokemonsIdListParamsSchema, PokemonsListParam} from '@/services/pokemon/types';
...
export function usePokemonList(listParams: PokemonsListParam | PokemonsIdListParamsSchema) {
